...
#loop.
    ...
    def user_correct(x,y):
        ...
        print(f"{x} is correct! You now have {y} points! :D")
    ...
    if retake == "yes" or retake == "Yes":
        print("Goodluck on your next attempt! ^_^")
        rerun = True
    else:  
        rerun = False 
        print("Goodbye! O_< ")   
        ...
        while user_choice not in ["yes", "no", "Yes", "No"]:
            print("That is an invalid answer. Please answer again with either 'Yes' or 'No'")
            user_choice = input("Do you wish to add your own question to the quiz? Answer with 'Yes' or 'No'")
        while user_choice == ['yes', 'Yes']:
            user_ques = input("Please enter your selected question: ")
            
            user_ans = input("Enter your questions correct answer: ")
            user_opt = input("Enter option A: ")
            user_opt = input("Enter option B: ")
            user_opt = input("Enter option C: ")
            user_opt = input("Enter option D: ")
            user_choice = input("Do you want to create another question?")
